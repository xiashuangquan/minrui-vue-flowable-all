...
import com.minrui.license.domain.CustomKeyStoreParam;
...
//            String tempFilePath = MinRuiConfig.getProfile() + "/license.lic";
            String tempFilePath = param.getLicenseUploadPath() + "/license.lic";
