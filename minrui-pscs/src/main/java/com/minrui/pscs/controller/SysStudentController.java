package com.minrui.pscs.controller;
...
public class SysStudentController extends BaseController
{
     ...
     * 查询学生信息列表
     */
    @PreAuthorize("@ss.hasPermi('pscs:student:list')")
    @GetMapping("/list")
     ...
     * 导出学生信息列表
     */
    @PreAuthorize("@ss.hasPermi('pscs:student:export')")
     ...
     * 获取学生信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('pscs:student:query')")
     ...
     * 新增学生信息
     */
    @PreAuthorize("@ss.hasPermi('pscs:student:add')")
     ...
     * 修改学生信息
     */
    @PreAuthorize("@ss.hasPermi('pscs:student:edit')")
     ...
     * 删除学生信息
     */
    @PreAuthorize("@ss.hasPermi('pscs:student:remove')")
